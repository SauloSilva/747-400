...
B747.fuel.stab_tank.xfr_jett_pump_R		= {}
    ...
    B747.fuel.center_tank.ovrd_jett_pump_L.on		= create_dataref("laminar/B747/fuel/center_tank/ovrd_jett_pump_L_on", "number")
    B747.fuel.center_tank.ovrd_jett_pump_R.on		= create_dataref("laminar/B747/fuel/center_tank/ovrd_jett_pump_R_on", "number")
    B747.fuel.center_tank.scvg_pump_L1.on			= create_dataref("laminar/B747/fuel/center_tank/scvg_pump_L1_on", "number")
    B747.fuel.center_tank.scvg_pump_L2.on			= create_dataref("laminar/B747/fuel/center_tank/scvg_pump_L2_on", "number")
    B747.fuel.center_tank.scvg_pump_R1.on			= create_dataref("laminar/B747/fuel/center_tank/scvg_pump_R1_on", "number")
    B747.fuel.center_tank.scvg_pump_R2.on			= create_dataref("laminar/B747/fuel/center_tank/scvg_pump_R2_on", "number")

    B747.fuel.main1_tank.main_pump_fwd.on			= create_dataref("laminar/B747/fuel/main1_tank/main_pump_fwd_on", "number")
    B747.fuel.main1_tank.main_pump_aft.on			= create_dataref("laminar/B747/fuel/main1_tank/main_pump_aft_on", "number")

    B747.fuel.main2_tank.main_pump_fwd.on			= create_dataref("laminar/B747/fuel/main2_tank/main_pump_fwd_on", "number")
    B747.fuel.main2_tank.main_pump_aft.on			= create_dataref("laminar/B747/fuel/main2_tank/main_pump_aft_on", "number")
    B747.fuel.main2_tank.ovrd_jett_pump_fwd.on	    = create_dataref("laminar/B747/fuel/main2_tank/ovrd_jett_pump_fwd_on", "number")
    B747.fuel.main2_tank.ovrd_jett_pump_aft.on	    = create_dataref("laminar/B747/fuel/main2_tank/ovrd_jett_pump_aft_on", "number")
    B747.fuel.main2_tank.apu_dc_pump.on			    = create_dataref("laminar/B747/fuel/main2_tank/apu_dc_pump_on", "number")

    B747.fuel.main3_tank.main_pump_fwd.on			= create_dataref("laminar/B747/fuel/main3_tank/main_pump_fwd_on", "number")
    B747.fuel.main3_tank.main_pump_aft.on			= create_dataref("laminar/B747/fuel/main3_tank/main_pump_aft_on", "number")
    B747.fuel.main3_tank.ovrd_jett_pump_fwd.on	    = create_dataref("laminar/B747/fuel/main3_tank/ovrd_jett_pump_fwd_on", "number")
    B747.fuel.main3_tank.ovrd_jett_pump_aft.on	    = create_dataref("laminar/B747/fuel/main3_tank/ovrd_jett_pump_aft_on", "number")

    B747.fuel.main4_tank.main_pump_fwd.on			= create_dataref("laminar/B747/fuel/main4_tank/main_pump_fwd_on", "number")
    B747.fuel.main4_tank.main_pump_aft.on			= create_dataref("laminar/B747/fuel/main4_tank/main_pump_aft_on", "number")

    B747.fuel.stab_tank.xfr_jett_pump_L.on		    = create_dataref("laminar/B747/fuel/stab_tank/xfr_jett_pump_L_on", "number")
    B747.fuel.stab_tank.xfr_jett_pump_R.on		    = create_dataref("laminar/B747/fuel/stab_tank/xfr_jett_pump_R_on", "number")
...
B747.fuel.jett_nozzle_vlv_R				= {}
    ...
    -- VALVE POS
    B747.fuel.center_tank.refuel_vlv_L.pos	    = create_dataref("laminar/B747/fuel/center_tank/refuel_vlv_L_pos", "number")
    B747.fuel.center_tank.refuel_vlv_R.pos	    = create_dataref("laminar/B747/fuel/center_tank/refuel_vlv_R_pos", "number")
    B747.fuel.center_tank.jett_vlv_L.pos	    = create_dataref("laminar/B747/fuel/center_tank/jett_vlv_L_pos", "number")
    B747.fuel.center_tank.jett_vlv_R.pos	    = create_dataref("laminar/B747/fuel/center_tank/jett_vlv_R_pos", "number")
    B747.fuel.center_tank.stab_xfr_vlv_L.pos    = create_dataref("laminar/B747/fuel/center_tank/stab_xfr_vlv_L_pos", "number")
    B747.fuel.center_tank.stab_xfr_vlv_R.pos    = create_dataref("laminar/B747/fuel/center_tank/stab_xfr_vlv_R_pos", "number")
    B747.fuel.center_tank.flow_eq_vlv.pos	    = create_dataref("laminar/B747/fuel/center_tank/flow_eq_vlv_pos", "number")

    B747.fuel.main1_tank.refuel_vlv.pos		    = create_dataref("laminar/B747/fuel/main1_tank/refuel_vlv_pos", "number")
    B747.fuel.main1_tank.main_xfr_vlv.pos	    = create_dataref("laminar/B747/fuel/main1_tank/main_xfr_vlv_pos", "number")

    B747.fuel.main2_tank.refuel_vlv_L.pos	    = create_dataref("laminar/B747/fuel/main2_tank/refuel_vlv_L_pos", "number")
    B747.fuel.main2_tank.refuel_vlv_R.pos	    = create_dataref("laminar/B747/fuel/main2_tank/refuel_vlv_R_pos", "number")
    B747.fuel.main2_tank.jett_vlv.pos		    = create_dataref("laminar/B747/fuel/main2_tank/jett_vlv_pos", "number")
    B747.fuel.main2_tank.apu_vlv.pos		    = create_dataref("laminar/B747/fuel/main2_tank/apu_vlv_pos", "number")

    B747.fuel.main3_tank.refuel_vlv_L.pos	    = create_dataref("laminar/B747/fuel/main3_tank/refuel_vlv_L_pos", "number")
    B747.fuel.main3_tank.refuel_vlv_R.pos	    = create_dataref("laminar/B747/fuel/main3_tank/refuel_vlv_R_pos", "number")
    B747.fuel.main3_tank.jett_vlv.pos		    = create_dataref("laminar/B747/fuel/main3_tank/jett_vlv_pos", "number")

    B747.fuel.main4_tank.refuel_vlv.pos	        = create_dataref("laminar/B747/fuel/main4_tank/refuel_vlv_pos", "number")
    B747.fuel.main4_tank.main_xfr_vlv.pos	    = create_dataref("laminar/B747/fuel/main4_tank/main_xfr_vlv_pos", "number")

    B747.fuel.stab_tank.refuel_vlv.pos		    = create_dataref("laminar/B747/fuel/stab_tank/refuel_vlv_pos", "number")
    B747.fuel.stab_tank.isolation_vlv_L.pos	    = create_dataref("laminar/B747/fuel/stab_tank/isolation_vlv_L_pos", "number")
    B747.fuel.stab_tank.xfr_jett_vlv_L.pos	    = create_dataref("laminar/B747/fuel/stab_tank/xfr_jett_vlv_L_pos", "number")
    B747.fuel.stab_tank.isolation_vlv_R.pos	    = create_dataref("laminar/B747/fuel/stab_tank/isolation_vlv_R_pos", "number")
    B747.fuel.stab_tank.xfr_jett_vlv_R.pos	    = create_dataref("laminar/B747/fuel/stab_tank/xfr_jett_vlv_R_pos", "number")

    B747.fuel.res2_tank.refuel_vlv.pos		    = create_dataref("laminar/B747/fuel/res2_tank/refuel_vlv_pos", "number")
    B747.fuel.res2_tank.xfr_vlv_A.pos		    = create_dataref("laminar/B747/fuel/res2_tank/xfr_vlv_A_pos", "number")
    B747.fuel.res2_tank.xfr_vlv_B.pos		    = create_dataref("laminar/B747/fuel/res2_tank/xfr_vlv_B_pos", "number")

    B747.fuel.res3_tank.refuel_vlv.pos		    = create_dataref("laminar/B747/fuel/res3_tank/refuel_vlv_pos", "number")
    B747.fuel.res3_tank.xfr_vlv_A.pos		    = create_dataref("laminar/B747/fuel/res3_tank/xfr_vlv_A_pos", "number")
    B747.fuel.res3_tank.xfr_vlv_B.pos		    = create_dataref("laminar/B747/fuel/res3_tank/xfr_vlv_B_pos", "number")

    B747.fuel.engine1.xfeed_vlv.pos		        = create_dataref("laminar/B747/fuel/engine1/xfeed_vlv_pos", "number")
    B747.fuel.engine2.xfeed_vlv.pos		        = create_dataref("laminar/B747/fuel/engine2/xfeed_vlv_pos", "number")
    B747.fuel.engine3.xfeed_vlv.pos		        = create_dataref("laminar/B747/fuel/engine3/xfeed_vlv_pos", "number")
    B747.fuel.engine4.xfeed_vlv.pos		        = create_dataref("laminar/B747/fuel/engine4/xfeed_vlv_pos", "number")

    B747.fuel.spar_vlv1.pos					    = create_dataref("laminar/B747/fuel/spar_vlv1_pos", "number")
    B747.fuel.spar_vlv2.pos					    = create_dataref("laminar/B747/fuel/spar_vlv2_pos", "number")
    B747.fuel.spar_vlv3.pos				        = create_dataref("laminar/B747/fuel/spar_vlv3_pos", "number")
    B747.fuel.spar_vlv4.pos				        = create_dataref("laminar/B747/fuel/spar_vlv4_pos", "number")

    B747.fuel.jett_nozzle_vlv_L.pos			    = create_dataref("laminar/B747/fuel/jett_nozzle_vlv_L_pos", "number")
    B747.fuel.jett_nozzle_vlv_R.pos			    = create_dataref("laminar/B747/fuel/jett_nozzle_vlv_R_pos", "number")
...
B747DR_fuel_jettison_sel_dial_pos       = create_dataref("laminar/B747/fuel/fuel_jettison/sel_dial_pos", "number")
B747DR_fuel_control_toggle_switch_pos   = create_dataref("laminar/B747/fuel/fuel_control/toggle_sw_pos", "array[4]")

B747DR_stab_fuel_pump_press_low_L       = create_dataref("laminar/B747/fuel/stab_pump_L/pressure_low", "number")
B747DR_stab_fuel_pump_press_low_R       = create_dataref("laminar/B747/fuel/stab_pump_R/pressure_low", "number")

B747DR_stab_xfr_status                  = create_dataref("laminar/B747/fuel/stab_xfr_status", "number")
B747DR_res2_xfr_status                  = create_dataref("laminar/B747/fuel/res2_xfr_status", "number")
B747DR_res3_xfr_status                  = create_dataref("laminar/B747/fuel/res3_xfr_status", "number")
B747DR_ctr_scvg_L_status                = create_dataref("laminar/B747/fuel/ctr_scvg_L_status", "number")
B747DR_ctr_scvg_R_status                = create_dataref("laminar/B747/fuel/ctr_scvg_R_status", "number")

B747DR_fuel_temperature                 = create_dataref("laminar/B747/fuel/temperature", "number")

B747DR_jett_time                        = create_dataref("laminar/B747/fuel/jettison_time", "number")


B747DR_gen_fuel_XFmfld_status           = create_dataref("laminar/B747/fuel/gen_XFmfld_status", "number")

B747DR_gen_fuel_engine1_status          = create_dataref("laminar/B747/fuel/engine1_status", "number")
B747DR_gen_fuel_engine2_status          = create_dataref("laminar/B747/fuel/engine2_status", "number")
B747DR_gen_fuel_engine3_status          = create_dataref("laminar/B747/fuel/engine3_status", "number")
B747DR_gen_fuel_engine4_status          = create_dataref("laminar/B747/fuel/engine4_status", "number")

B747DR_gen_fuel_OJpump2_status          = create_dataref("laminar/B747/fuel/oj_pump2_status", "number")
B747DR_gen_fuel_OJpump3_status          = create_dataref("laminar/B747/fuel/oj_pump3_status", "number")

B747DR_gen_jett_valve_status            = create_dataref("laminar/B747/fuel/jett_vlv_status", "number")
B747DR_gen_jett_OJctrL_status           = create_dataref("laminar/B747/fuel/jett/OJctrL_status", "number")
B747DR_gen_jett_OJctrR_status           = create_dataref("laminar/B747/fuel/jett/OJctrR_status", "number")
B747DR_gen_jett_OJmain2_status          = create_dataref("laminar/B747/fuel/jett/OJmain2_status", "number")
B747DR_gen_jett_OJmain3_status          = create_dataref("laminar/B747/fuel/jett/OJmain3_status", "number")
B747DR_gen_jett_OJstab_status           = create_dataref("laminar/B747/fuel/jett/OJstab_status", "number")
B747DR_gen_jett_mfldL1_status           = create_dataref("laminar/B747/fuel/jett/mfldL1_status", "number")
B747DR_gen_jett_mfldL2_status           = create_dataref("laminar/B747/fuel/jett/mfldL2_status", "number")
B747DR_gen_jett_mfldL3_status           = create_dataref("laminar/B747/fuel/jett/mfldL3_status", "number")
B747DR_gen_jett_mfldR1_status           = create_dataref("laminar/B747/fuel/jett/mfldR1_status", "number")
B747DR_gen_jett_mfldR2_status           = create_dataref("laminar/B747/fuel/jett/mfldR2_status", "number")
B747DR_gen_jett_mfldR3_status           = create_dataref("laminar/B747/fuel/jett/mfldR3_status", "number")
B747DR_gen_jett_Xmfld_status            = create_dataref("laminar/B747/fuel/jett/mXmfld_status", "number")

B747DR_gen_xfeed_vlv1_status            = create_dataref("laminar/B747/fuel/gen/xfeed_vlv1_status", "number")
B747DR_gen_xfeed_vlv2_status            = create_dataref("laminar/B747/fuel/gen/xfeed_vlv2_status", "number")
B747DR_gen_xfeed_vlv3_status            = create_dataref("laminar/B747/fuel/gen/xfeed_vlv3_status", "number")
B747DR_gen_xfeed_vlv4_status            = create_dataref("laminar/B747/fuel/gen/xfeed_vlv4_status", "number")


B747DR_init_fuel_CD                     = create_dataref("laminar/B747/fuel/init_CD", "number")
...
-- FUEL TO REMAIN
B747DR_fuel_to_remain_rheo      = create_dataref("laminar/B747/fuel/fuel_to_remain/rheostat", "number", B747DR_fuel_to_remain_rheo_DRhandler)
...
B747CMD_fuel_jettison_sel_up 	= create_command("laminar/B747/fuel/fuel_jett/el_dial_up", "Fuel Jettison Selector Dial Up", B747_fuel_jettison_sel_up_CMDhandler)
B747CMD_fuel_jettison_sel_dn 	= create_command("laminar/B747/fuel/fuel_jett/sel_dial_dn", "Fuel Jettison Selector Dial Down", B747_fuel_jettison_sel_dn_CMDhandler)



-- TQ FUEL CONTROL SWITCHES
B747CMD_fuel_control_switch1 	= create_command("laminar/B747/fuel/fuel_control_1/toggle_switch", "Fuel Control Switch 1", B747_fuel_control_switch1_CMDhandler)
B747CMD_fuel_control_switch2 	= create_command("laminar/B747/fuel/fuel_control_2/toggle_switch", "Fuel Control Switch 2", B747_fuel_control_switch2_CMDhandler)
B747CMD_fuel_control_switch3 	= create_command("laminar/B747/fuel/fuel_control_3/toggle_switch", "Fuel Control Switch 3", B747_fuel_control_switch3_CMDhandler)
B747CMD_fuel_control_switch4 	= create_command("laminar/B747/fuel/fuel_control_4/toggle_switch", "Fuel Control Switch 4", B747_fuel_control_switch4_CMDhandler)


-- AI
B747CMD_ai_fuel_quick_start		= create_command("laminar/B747/ai/fuel_quick_start", "number", B747_ai_fuek_quick_start_CMDhandler)
