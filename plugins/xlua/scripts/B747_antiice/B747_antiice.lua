...
B747DR_windshield_wiper_sel_L_pos   = create_dataref("laminar/B747/antiice/wndshlsd_wiper_L/sel_dial_pos", "number")
B747DR_windshield_wiper_sel_R_pos   = create_dataref("laminar/B747/antiice/wndshlsd_wiper_R/sel_dial_pos", "number")

B747DR_nacelle_ai_valve_pos         = create_dataref("laminar/B747/antiice/nacelle/valve_pos", "array[4)")
B747DR_wing_ai_valve_pos            = create_dataref("laminar/B747/antiice/wing/valve_pos", "array[2)")

B747DR_init_ice_CD                  = create_dataref("laminar/B747/ice/init_CD", "number")
...
-- WINDSHIELD WIPERS
B747CMD_windshield_wiper_sel_L_up 	= create_command("laminar/B747/antiice/wndshlsd_wiper_L/sel_dial_up", "Windshield Wiper Selector Dial Left Up", B747_windshield_wiper_sel_L_up_CMDhandler)
B747CMD_windshield_wiper_sel_L_dn 	= create_command("laminar/B747/antiice/wndshlsd_wiper_L/sel_dial_dn", "Windshield Wiper Selector Dial Left Down", B747_windshield_wiper_sel_L_dn_CMDhandler)

B747CMD_windshield_wiper_sel_R_up 	= create_command("laminar/B747/antiice/wndshlsd_wiper_R/sel_dial_up", "Windshield Wiper Selector Dial Right Up", B747_windshield_wiper_sel_R_up_CMDhandler)
B747CMD_windshield_wiper_sel_R_dn 	= create_command("laminar/B747/antiice/wndshlsd_wiper_R/sel_dial_dn", "Windshield Wiper Selector Dial Right Down", B747_windshield_wiper_sel_R_dn_CMDhandler)


-- AI
B747CMD_ai_antiice_quick_start			= create_command("laminar/B747/ai/antiice_quick_start", "number", B747_ai_antiice_quick_start_CMDhandler)
