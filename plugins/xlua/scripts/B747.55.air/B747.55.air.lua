...
B747bleedAir.engine1.bleed_air_valve.pos        = create_dataref("laminar/B747/air/engine1/bleed_valve_pos", "number")
B747bleedAir.engine2.bleed_air_valve.pos        = create_dataref("laminar/B747/air/engine2/bleed_valve_pos", "number")
B747bleedAir.engine3.bleed_air_valve.pos        = create_dataref("laminar/B747/air/engine3/bleed_valve_pos", "number")
B747bleedAir.engine4.bleed_air_valve.pos        = create_dataref("laminar/B747/air/engine4/bleed_valve_pos", "number")
B747bleedAir.engine1.bleed_air_start_valve.pos  = create_dataref("laminar/B747/air/engine1/bleed_start_valve_pos", "number")
B747bleedAir.engine2.bleed_air_start_valve.pos  = create_dataref("laminar/B747/air/engine2/bleed_start_valve_pos", "number")
B747bleedAir.engine3.bleed_air_start_valve.pos  = create_dataref("laminar/B747/air/engine3/bleed_start_valve_pos", "number")
B747bleedAir.engine4.bleed_air_start_valve.pos  = create_dataref("laminar/B747/air/engine4/bleed_start_valve_pos", "number")
B747bleedAir.apu.bleed_air_valve.pos            = create_dataref("laminar/B747/air/apu/bleed_valve_pos", "number")
B747bleedAir.isolation_valve_L.pos              = create_dataref("laminar/B747/air/isolation_valve_L_pos", "number")
B747bleedAir.isolation_valve_R.pos              = create_dataref("laminar/B747/air/isolation_valve_R_pos", "number")
...
B747DR_cabin_alt_auto_sel_pos       = create_dataref("laminar/B747/air/cabin_alt_auto/sel_dial_pos", "number")
B747DR_equip_cooling_sel_pos        = create_dataref("laminar/B747/air/equip_cooling/sel_dial_pos", "number")
B747DR_pack_ctrl_sel_pos            = create_dataref("laminar/B747/air/pack_ctrl/sel_dial_pos", "array[3]")
B747DR_landing_alt_button_pos       = create_dataref("laminar/B747/air/landing_alt/button_pos", "number")

B747DR_outflow_valve_pos_L          = create_dataref("laminar/B747/air/outflow_valve_left/pos", "number")
B747DR_outflow_valve_pos_R          = create_dataref("laminar/B747/air/outflow_valve_right/pos", "number")
...
B747DR_init_air_CD                  = create_dataref("laminar/B747/air/init_CD", "number")
...
function B747DR_landing_alt_sel_rheo_DRhandler() end


-- PASSENGER TEMP CONTROL
function B747DR_pass_temp_ctrl_rheo_DRhandler() end


-- FLIGHT DECK TEMP CONTROL
function B747DR_flt_deck_temp_ctrl_rheo_DRhandler() end


-- CARGO TEMP CONTROL
function B747DR_cargo_temp_ctrl_rheo_DRhandler() end
...
-- LANDING ALTITUDE SELECTOR
B747DR_landing_alt_sel_rheo     = create_dataref("laminar/B747/air/land_alt_sel/rheostat", "number", B747DR_landing_alt_sel_rheo_DRhandler)


-- PASSENGER TEMP CONTROL
B747DR_pass_temp_ctrl__rheo     = create_dataref("laminar/B747/air/pass_temp_ctrl/rheostat", "number", B747DR_pass_temp_ctrl_rheo_DRhandler)


-- FLIGHT DECK TEMP CONTROL
B747DR_flt_deck_temp_ctrl_rheo  = create_dataref("laminar/B747/air/flt_deck_temp_ctrl/rheostat", "number", B747DR_flt_deck_temp_ctrl_rheo_DRhandler)


-- CARGO TEMP CONTROL
B747DR_cargo_temp_ctrl_rheo     = create_dataref("laminar/B747/air/cargo_temp_ctrl/rheostat", "number", B747DR_cargo_temp_ctrl_rheo_DRhandler)
...
-- CABIN ALTITUDE AUTO SELECTOR
B747CMD_cabin_alt_auto_sel_up = create_command("laminar/B747/air/cabin_alt_auto/sel_dial_up", "Cabin Altitude Selector Dial Up", B747_cabin_alt_auto_sel_up_CMDhandler)
B747CMD_cabin_alt_auto_sel_dn = create_command("laminar/B747/air/cabin_alt_auto/sel_dial_dn", "Cabin Altitude Selector Dial Down", B747_cabin_alt_auto_sel_dn_CMDhandler)



-- EQUIPMENT COOLING SELECTOR
B747CMD_equip_cooling_sel_up = create_command("laminar/B747/air/equip_cooling/sel_dial_up", "Equipment Coooling Selector Dial Up", B747_equip_cooling_sel_up_CMDhandler)
B747CMD_equip_cooling_sel_dn = create_command("laminar/B747/air/equip_cooling/sel_dial_dn", "Equipment Coooling Selector Dial Down", B747_equip_cooling_sel_dn_CMDhandler)



-- PACK CONTROL SELECTOR
B747CMD_pack_ctrl_sel_01_up = create_command("laminar/B747/air/pack_ctrl_01/sel_dial_up", "Equipment Coooling Selector 1 Dial Up", B747_pack_ctrl_sel_01_up_CMDhandler)
B747CMD_pack_ctrl_sel_01_dn = create_command("laminar/B747/air/pack_ctrl_01/sel_dial_dn", "Equipment Coooling Selector 1 Dial Down", B747_pack_ctrl_sel_01_dn_CMDhandler)

B747CMD_pack_ctrl_sel_02_up = create_command("laminar/B747/air/pack_ctrl_02/sel_dial_up", "Equipment Coooling Selector 2 Dial Up", B747_pack_ctrl_sel_02_up_CMDhandler)
B747CMD_pack_ctrl_sel_02_dn = create_command("laminar/B747/air/pack_ctrl_02/sel_dial_dn", "Equipment Coooling Selector 2 Dial Down", B747_pack_ctrl_sel_02_dn_CMDhandler)

B747CMD_pack_ctrl_sel_03_up = create_command("laminar/B747/air/pack_ctrl_03/sel_dial_up", "Equipment Coooling Selector 3 Dial Up", B747_pack_ctrl_sel_03_up_CMDhandler)
B747CMD_pack_ctrl_sel_03_dn = create_command("laminar/B747/air/pack_ctrl_03/sel_dial_dn", "Equipment Coooling Selector 3 Dial Down", B747_pack_ctrl_sel_03_dn_CMDhandler)


-- LANDING ALTITUDE SWITCH
B747CMD_landing_alt_button = create_command("laminar/B747/air/landing_alt/button", "Landing Altitude Button", B747_landing_alt_button_CMDhandler)


-- AI
B747CMD_ai_air_quick_start = create_command("laminar/B747/ai/air_quick_start", "number", B747_ai_air_quick_start_CMDhandler)
