...
B747DR_sfty_no_smoke_sel_dial_pos   = create_dataref("laminar/B747/safety/no_smoking/sel_dial_pos", "number")
B747DR_sfty_seat_belts_sel_dial_pos = create_dataref("laminar/B747/safety/seat_belts/sel_dial_pos", "number")

B747DR_init_safety_CD               = create_dataref("laminar/B747/safety/init_CD", "number")
...
B747DR_checklist_marker_capt        = create_dataref("laminar/B747/safety/checklist_marker_capt", "number", B747_checklist_marker_capt_DRhandler)
B747DR_checklist_marker_fo          = create_dataref("laminar/B747/safety/checklist_marker_fo", "number", B747_checklist_marker_fo_DRhandler)
...
-- NO SMOKING DIAL
B747CMD_sfty_no_smoke_sel_dial_up   = create_command("laminar/B747/safety/no_smoking/sel_dial_up", "No Smoking Selector Dial Up", B747_sfty_no_smoke_sel_dial_up_CMDhandler)
B747CMD_sfty_no_smoke_sel_dial_dn   = create_command("laminar/B747/safety/no_smoking/sel_dial_dn", "No Smoking Selector Dial Down", B747_sfty_no_smoke_sel_dial_dn_CMDhandler)


-- SEAT BELTS DIAL
B747CMD_sfty_seat_belts_sel_dial_up = create_command("laminar/B747/safety/seat_belts/sel_dial_up", "Seat Belts Selector Dial Up", B747_sfty_seat_belts_sel_dial_up_CMDhandler)
B747CMD_sfty_seat_belts_sel_dial_dn = create_command("laminar/B747/safety/seat_belts/sel_dial_dn", "Seat Belts Selector Dial_Down", B747_sfty_seat_belts_sel_dial_dn_CMDhandler)



-- AI
B747CMD_ai_safety_quick_start			= create_command("laminar/B747/ai/safety_quick_start", "number", B747_ai_safety_quick_start_CMDhandler)
