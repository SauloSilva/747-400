...
B747DR_iru_mode_sel_pos         = create_dataref("laminar/B747/flt_mgmt/iru/mode_sel_dial_pos", "array[4]")
B747DR_xpdrMode_sel_pos         = create_dataref("laminar/B747/flt_mgmt/txpdr/mode_sel_pos", "number")
B747DR_xpdr_sel_pos             = create_dataref("laminar/B747/flt_mgmt/transponder/sel_dial_pos", "number")
B747DR_ident_button_pos         = create_dataref("laminar/B747/flt_mgmt/transponder/ident_btn_pos", "number")
B747DR_xpdr_code_12_dial_pos    = create_dataref("laminar/B747/flt_mgmt/transponder_code/digts_12_dial_pos", "number")
B747DR_xpdr_code_34_dial_pos    = create_dataref("laminar/B747/flt_mgmt/transponder_code/digts_34_dial_pos", "number")

B747DR_init_fltmgmt_CD          = create_dataref("laminar/B747/fltmgmt/init_CD", "number")
...
function B747_flt_xpdr_mode_sel_dial_up_CMDhandler(phase, duration)
    if phase == 0 then
        B747DR_xpdrMode_sel_pos = math.min(B747DR_xpdrMode_sel_pos+1, 2)
        simDR_xpdr_mode = B747DR_xpdrMode_sel_pos+1
    end
end
...
-- IRU MODE SELECTORS
B747CMD_flt_mgmgt_iru_mode_sel_L_up = create_command("laminar/B747/flt_mgmt/iru/mode_sel_dial_L_up", "Flight Management IRU Mode Selector L Up", B747_flt_mgmgt_iru_mode_sel_L_up_CMDhandler)
B747CMD_flt_mgmgt_iru_mode_sel_L_dn = create_command("laminar/B747/flt_mgmt/iru/mode_sel_dial_L_dn", "Flight Management IRU Mode Selector L Down", B747_flt_mgmgt_iru_mode_sel_L_dn_CMDhandler)

B747CMD_flt_mgmgt_iru_mode_sel_C_up = create_command("laminar/B747/flt_mgmt/iru/mode_sel_dial_C_up", "Flight Management IRU Mode Selector C Up", B747_flt_mgmgt_iru_mode_sel_C_up_CMDhandler)
B747CMD_flt_mgmgt_iru_mode_sel_C_dn = create_command("laminar/B747/flt_mgmt/iru/mode_sel_dial_C_dn", "Flight Management IRU Mode Selector C Down", B747_flt_mgmgt_iru_mode_sel_C_dn_CMDhandler)

B747CMD_flt_mgmgt_iru_mode_sel_R_up = create_command("laminar/B747/flt_mgmt/iru/mode_sel_dial_R_up", "Flight Management IRU Mode Selector R Up", B747_flt_mgmgt_iru_mode_sel_R_up_CMDhandler)
B747CMD_flt_mgmgt_iru_mode_sel_R_dn = create_command("laminar/B747/flt_mgmt/iru/mode_sel_dial_R_dn", "Flight Management IRU Mode Selector R Down", B747_flt_mgmgt_iru_mode_sel_R_dn_CMDhandler)



--TRANSPONDER
B747CMD_flt_xpdr_mode_sel_dial_up   = create_command("laminar/B747/flt_mgmt/transponder/mode_sel_dial_up", "Flight Management Transponder Mode Selector Dial Up", B747_flt_xpdr_mode_sel_dial_up_CMDhandler)
B747CMD_flt_xpdr_mode_sel_dial_dn   = create_command("laminar/B747/flt_mgmt/transponder/mode_sel_dial_dn", "Flight Management Transponder Mode Selector Dial Down", B747_flt_xpdr_mode_sel_dial_dn_CMDhandler)


B747CMD_flt_xpdr_sel_dial           = create_command("laminar/B747/flt_mgmt/transponder/sel_dial", "Flight Management Transponder Selector Dial", B747_flt_xpdr_sel_dial_CMDhandler)



-- AI
B747CMD_ai_fltmgmt_quick_start		= create_command("laminar/B747/ai/fltmgmt_quick_start", "number", B747_ai_fltmgmt_quick_start_CMDhandler)
